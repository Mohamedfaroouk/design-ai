...
const loadProduct = async () => {
  loading.value = true
  try {
    const response = await productsStore.fetchOne(route.params.id)
    product.value = response.data
  } catch (error) {
    toast.error(error.message || t('common.error'))
    router.push({ name: 'client.products.index' })
  } finally {
    loading.value = false
  }
}
    ...
    <div class=" mx-auto">
      ...
      <div v-else-if="product">
        ...
        <div class="mb-6 flex justify-between items-start">
          <div class="flex items-start gap-4">
            ...
            <div>
              <div class="flex items-center gap-3 mb-2">
                ...
                <span class="px-2 py-1 rounded-full text-xs font-medium" :class="platformColors[product.platform]">
          ...
          <Button variant="primary" @click="createNewImage">

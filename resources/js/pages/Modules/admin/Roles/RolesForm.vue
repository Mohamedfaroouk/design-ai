<template>
    <div>
        <div v-motion-fade>
            <Head :title="isEditing ? $t('roles.editRole') : $t('roles.addNew')" />
            ...
            <div class="rounded-lg shadow p-6 transition-colors"
                ...
                <form @submit.prevent="handleSubmit">
                    ...
                    <div class="mb-6">
                        ...
                        <p v-if="form.errors.permissions" class="mt-1 text-sm text-red-500">
...
const isSystemRole = ref(props.role?.is_system || false)
